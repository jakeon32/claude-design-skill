...
### 🔴 밀도를 올리는 방법은 "글자를 더 넣는 것"이 아니다

| ✕ 하지 말 것 | ○ 할 것 |
|---|---|
| 텍스트를 더 욱여넣는다 | **색면** — 배경 블록 · 강조 영역 |
| 폰트를 키워 억지로 채운다 | **이미지 · 사진** (풀블리드 · 반폭) |
| 여백을 없앤다 | **도형 · 도해** — 텍스트를 구조로 대체 |
| | **요소를 키운다** — L5 수치 · 제목을 과감하게 |

**여백은 줄이는 게 아니라, 채울 것을 넣는 것이다.**

```bash
python tools/measure_density.py slide-01.png slide-02.png
python tools/measure_density.py deck.pdf
```
